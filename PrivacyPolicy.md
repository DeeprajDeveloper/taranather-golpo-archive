...
Thank you for visiting the **Taranath Tantrik Golpo Archive** (https://taranather-golpo-archive.vercel.app/). Your privacy is deeply important to us. Because this application is a non-commercial, fan-made index, our approach to privacy is simple: **We do not collect, store, or share your personal data.**

Here is exactly how the app handles information:

## 1. No Data Collection or Databases
...
Any actions you take on the site—such as marking a story as read, saving favorites, or system preferences (like dark mode)—are processed and stored entirely on your own device using your browser's local cache or local storage. 
...
If you have any questions about this privacy notice, or if you are a copyright holder with questions about the indexed links, please reach out to us at:
